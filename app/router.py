...
@router.post("/deck/{user_id}", response_description="Add new deck", response_model=Deck)
async def create_deck(user_id: str, deck: Deck = Body(...)):
...
@router.post("/card/{user_id}/{deck_id}", response_description="Add new card")
async def create_card(user_id: str, deck_id: str, card: Card = Body(...)):
